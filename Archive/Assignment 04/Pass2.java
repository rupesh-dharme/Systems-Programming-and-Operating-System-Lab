...
public class Pass2 {
	...
	public static void main(String[] args) throws Exception {
		...
		HashMap<String, FillMNT> mnt=new HashMap<>();
		...
		while((line=mntb.readLine())!=null)
		{
			...
			mnt.put(parts[0], new FillMNT(parts[0], Integer.parseInt(parts[1]), Integer.parseInt(parts[2]), Integer.parseInt(parts[3]), Integer.parseInt(parts[4])));
